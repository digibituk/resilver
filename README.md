...
MagicMirror² is a great project that pioneered the space. Resilver is for anyone who wants the same result with less maintenance and fewer moving parts.
...
- **Self-updating** — opt-in automatic updates with SHA-256 checksum verification
